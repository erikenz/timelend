...
> = {
  ...
  meta: {
    modelProps: "user" | "commitment" | "payment";
    ...
    Commitment: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.CommitmentCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type CommitmentScalarFieldEnum =
  (typeof CommitmentScalarFieldEnum)[keyof typeof CommitmentScalarFieldEnum];
